...
function AddSchool({ setAddSchool }) {
                  ...
                  <div className="edit-modal bg-white p-3 rounded-1">
                        <div className="edit-modal-header d-flex justify-content-between align-items-center">
                              <div className="edit-pupil-title">
                                    <h3 className=''>Maktab qo'shish</h3>
                              </div>
                              <div className="close">
                                    <i onClick={() => setAddSchool(false)} className="fa-solid fa-rectangle-xmark text-danger"></i>
                              </div>
                        </div>
                        <div className="edit-pupil-body">
                              ...
                              <div className="row pt-1">
                                    <div className="col-6 d-flex flex-column gap-1">
                                          ...
                                          <Input id='city' onChange={(e)=>handle(e)} placeholder="" required />
                                    </div>
                                    <div className="col-6 d-flex flex-column gap-1">
                                          <label htmlFor="viloyat">Viloyat :</label>
                                          <Input id='viloyat' onChange={(e)=>handle(e)} placeholder="" required />
                                    </div>
                              </div>
                              <div className="row pt-1">
                                    <div className="col-6 d-flex flex-column gap-1">
                                          <label htmlFor="director">Direktor :</label>
                                          <Input id='director' onChange={(e)=>handle(e)} placeholder="" required />
                                    </div>
                                    <div className="col-6 d-flex flex-column gap-1">
                                          <label htmlFor="email">Email :</label>
                                          <Input type='email' id='email' onChange={(e)=>handle(e)} placeholder="" required />
                                    </div>
                              </div>
                              <div className="row pt-1">
                                    <div className="col-6 d-flex flex-column gap-1">
                                    ...
                                    <div className="col-6 d-flex flex-column gap-1">
                                          ...
                                          <Input id='primech' onChange={(e)=>handle(e)} placeholder="" required />
                                    </div>
                              </div>
                              <div className="row pt-4">
                                    <div className="col-6 d-flex flex-column gap-1">
                                          <button onClick={() => setAddSchool(false)} className="btn btn-danger rounded-1 pt-1 pb-1 ps-3 pe-3">Bekor qilish</button>
                                    </div>
                                    <div className="col-6 d-flex flex-column gap-1">
