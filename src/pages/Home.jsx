...
function Home() {
      return (
            <div className='home'>
                  <div className="navbar w-100 d-flex align-items-center justify-content-around pt-2 pb-2">
                        <div className="logo">
                              <img src={logo} alt="" />
                        </div>
                              ...
                              <div className="left">
                                    ...
                                    <div className="regions d-flex flex-column w-100">
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Buxoro viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Namangan viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Navoiy viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Andijon viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Toshkent viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Toshkent shaxri</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Farg'ona viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Xorazm viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Qoraqalpog'iston Respublikasi</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Samarqand viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Sirdaryo viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Jizzax viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Qashqadaryo viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Surxondaryo viloyati</Link>
                                          </div>
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>Vazirlik</Link>
                                          </div>
                                          ...
                                          <div className="region">
                                                <Link className='text-decoration-none text-primary reg-name' to='/login'>TMI</Link>
                                          </div>
                                    </div>
                              </div>
